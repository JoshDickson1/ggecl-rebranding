...
const RegisterIELTS = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-20 bg-white dark:bg-slate-950 transition-colors duration-300">
      {/* Header */}
      <h2 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-slate-50 mb-16 leading-tight uppercase tracking-tight">
        HOW TO REGISTER FOR <br />
        <span className="text-[#1e3a5f] dark:text-blue-400">IELTS</span>
      </h2>
      ...
      <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
        ...
        >
          <div className="relative aspect-square rounded-[3rem] overflow-hidden">
            ...
            />
            {/* Overlay Gradient: Deepens in dark mode */}
            <div className="absolute inset-0 bg-blue-900/20 dark:bg-[#1e3a5f]/40 mix-blend-overlay" />
          </div>
        </motion.div>
        ...
        <div className="w-full md:w-1/2 flex items-start gap-8">
          ...
          <div className="relative h-[400px] w-2 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden flex flex-col justify-between py-2">
            {/* The "Alive" moving pill */}
            <motion.div 
              className="absolute w-full bg-[#1e3a5f] dark:bg-blue-500 rounded-full shadow-[0_0_15px_rgba(30,58,95,0.4)] dark:shadow-blue-400/30"
              animate={{ 
                height: "60px",
            ...
            {STEPS.map((_, i) => (
              <div key={i} className="w-full h-1 bg-slate-200 dark:bg-slate-700" />
            ))}
          </div>
          ...
          <div className="flex-1 h-[400px] relative overflow-hidden">
            <AnimatePresence mode="wait">
              ...
              >
                {/* Previous Step (Faded) */}
                <div className="opacity-20 dark:opacity-30 select-none mb-8">
                  <h4 className="text-sm font-bold text-slate-400 dark:text-slate-500 uppercase">
                ...
                {/* Active Step */}
                <div className="mb-8">
                  <h3 className="text-2xl md:text-3xl font-black text-[#1e3a5f] dark:text-blue-400 mb-4 uppercase leading-none">
                ...
                {/* Next Step (Faded) */}
                <div className="opacity-20 dark:opacity-30 select-none">
                  <h4 className="text-sm font-bold text-slate-400 dark:text-slate-500 uppercase">
